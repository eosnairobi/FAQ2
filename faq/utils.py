    ...
    for i in range(200):
        ...
        for item in data['items']:
            ...
            if owner and question:
                a = Answer.objects.create(owner=owner, question=question, body=item['body'],
                                          se_question_id=qn_id, is_accepted=item['is_accepted'], se_answer_id=item['answer_id'], score=item['scor    e'])
